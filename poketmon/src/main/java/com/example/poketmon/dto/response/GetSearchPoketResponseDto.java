...
public class GetSearchPoketResponseDto extends ResponseDto{
  ...
  private List<GetPoketResponseDto> poketList;

  private GetSearchPoketResponseDto(String code, String message, List<GetPoketResponseDto> poketList) {
    super(code, message);
    this.poketList = poketList;
  }

  public static ResponseEntity<GetSearchPoketResponseDto> success(List<GetPoketResponseDto> poketList) {
